...
public class SystemDAO extends BaseDAO {
	...
	public VASystem mapRow(ResultSet rs, int rowNumber) throws SQLException {
	    ...
	    system.setItPortfolio(rs.getString("it_portfolio"));
    ...
    private static String ACTIVE_SYSTYEM_LIST_QUERY = "SELECT e.element_id, e.system_id, e.system_name, e.system_acronym, e.system_description,\r\n"
	    + "     lo0.description \"system_type\", lo1.description \"software_type\", lo2.description \"system_status\",\r\n"
	    + "     o.Parent_Org \"parent_organization\", spl0.organization_name,\r\n"
	    + "     lo3.description \"receiving_organization\",  p.port_name \"it_portfolio\", p.pl_name \"product_line\",\r\n"
	    + "     DECODE(e.external_facing_check,0,'False',null,'null','True') \"external_facing_check\",\r\n"
	    + "     lo4.description \"system_criticality\", lo7.description \"transformation_status\"\r\n"
	    + "     , lo10.description \"datastore_status\", DECODE(e.no_data_store_flag,0,'False',null,'null','True') \"no_data_store_flag\",\r\n"
	    ...
	    + "     lo16.description \"two_factor_pattern\" FROM ee.element_attr_c56 e, ee.list_option lo0\r\n"
	    + "     , ee.list_option lo1, ee.list_option lo2, ee.ELEMENT_ATTR_C53 spl0, ee.list_option lo3\r\n"
	    + "     , ee.list_option lo4, ee.list_option lo5, ee.ELEMENT_ATTR_C1416 spl1\r\n"
	    + "     , ee.list_option lo7, ee.list_option lo10, ee.ELEMENT_ATTR_C70 spl4, ee.list_option lo11\r\n"
	    + "     , ee.list_option lo12, ee.list_option lo14, ee.list_option lo15, ee.list_option lo16\r\n"
	    + "     , ee.list_option lo17, ee.list_option lo18, ee.list_option lo19\r\n"
	    ...
	    + "     , (SELECT pl.element_id, port.name port_name, pl.name pl_name FROM ee.element_attr_c1416 port\r\n"
	    + "           , ee.element_attr_c2125 pl WHERE port.element_id = pl.portfolio) p\r\n"
	    ...
	    + "     AND e.EPMO_PORTFOLIO = spl1.PORTFOLIO_ID (+) \r\n"
	    + "     AND lo7.option_id(+) = e.TRANSFORMATION_STATUS AND e.PRODUCT_LINE = p.ELEMENT_ID (+)\r\n"
	    + "     AND lo10.option_id(+) = e.DATASTORE_STATUS AND spl4.SYSTEM_ID(+)= e.SYSTEM_ID \r\n"
	    + "     AND spl4.BUSINESS_CONTINUITY__PICK_LIST = lo11.option_id(+)\r\n"
	    + "     AND spl4.SENSITIVE_DATA_PICK_LIST = lo12.option_id(+) \r\n"
	    + "     AND spl4.VULNERABILITY_SCANNING_STATUS = lo14.option_id(+) \r\n"
	    + "     AND spl4.TWO_FACTOR_AUTHENTICATION = lo15.OPTION_ID(+) \r\n"
	    + "     AND spl4.TWO_FACTOR_PATTERN = lo16.OPTION_ID(+)\r\n"
